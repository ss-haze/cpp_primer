...
int main()
{
	...
	if (s1 == s2)
		...
		cout << "The strings have equal length but contain different characters\n";
	else
		cout << "The strings are of different length\n";

	//compare two c-style strings using strcmp and strlen
	const char c1[] = "Character string", c2[] = "Character string";
	if (strcmp(c1, c2) == 0)
		cout << "The c-style strings are the identical\n";
	else if (strlen(c1) == strlen(c2))
		cout << "The c-style strings have equal length but contain different characters\n";
	else
		cout << "The c-style strings are of different length\n";
	...
	if (Length_c1 == Length_c2)
	{
		...
		for (; *pc1 != '\0' && *pc1 == *pc2; ++pc1, ++pc2)
			;
		if (*pc1 == '\0')
			cout << "The c-style strings are identical";
		else
			cout << "The c-style strings are of similar length but contain differenct characters";
	}
	else
		cout << "The c-style strings are of different length";
